...
return [
    ...
    'views' => [
        /*
         * Set title and tag line in the theme file instead of in a separate view
         *
        [
            'region'   => 'header', 
            'template' => 'me/header', 
        ...
        */
        ['region' => 'header', 'template' => 'idun/header', 'data' => [], 'sort' => -1],
        ['region' => 'footer', 'template' => 'idun/footer', 'data' => [], 'sort' => -1],
        // Load the navbar like a view
        [
            'region' => 'navbar', 
            'template' => [
                'callback' => function() {
